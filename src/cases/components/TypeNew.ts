import { Connected, Context, Late, MessageSourceType, Of } from 'silentium';
...
export function TypeNew(mapModel: MapModel) {
...
function TypeNewModal(opened$: MessageSourceType<boolean>, mapModel: MapModel) {
